...
case $1 in
	...
	;;
	"builtins")
	cc tests/builtins_tests.c builtins/echo.c builtins/pwd.c builtins/export.c env/env.c env/env_utils.c libft/build/libft.a -I. -I./libft -I./env -I./builtins -fsanitize=address -g && ./a.out
	;;
	"env")
